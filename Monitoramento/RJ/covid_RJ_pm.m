...
if (init == 11) city = 'Volta Redonda/RJ'; pop = 273012; color = [191,171,72]/255; end
if (init == 12) city = 'Macaé/RJ'; pop = 260497; color = [236,64,122]/255; end
...
if strcmp(city, 'Macaé/RJ') city = 'Macaé                             '; end 
...
if (init == 12) city = 'Macaé/RJ'; pop = 260497; color = [191,171,72]/255; end
