...
%Fontes de dados
arquivogeral = readtable('cases-brazil-cities-time.txt');
...
outputdir = datestr(tabela.date(length(tabela.date)),29);
...
hfonte=text((size(imagem,2) + space_imag+size(img_lista,2)),0,'Fonte: http://painel.saude.rj.gov.br/monitoramento/covid19.html');
