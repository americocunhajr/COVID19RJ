...
if (init == 8) city = 'Guapimirim/RJ'; pop = 260497; color = [236,64,122]/255; end
if (init == 7) city = 'Itaguaí/RJ'; pop = 6718903; color = [69,169,0]/255; end
if (init == 13) city = 'Japeri/RJ'; pop = 1084839; color = [255,130,113]/255; end
if (init == 10) city = 'Nilópolis/RJ'; pop = 524687; color = [209,227,105]/255; end
if (init == 12) city = 'Paracambi/RJ'; pop = 240592; color = [0,45,135]/255; end
if (init == 6) city = 'Queimados/RJ'; pop = 306191; color = [203,63,23]/255; end
if (init == 11) city = 'Seropédica/RJ'; pop = 273012; color = [0.5,0.5,0.5]; end
if (init == 3) city = 'Magé/RJ'; pop = 273012; color = [191,171,72]/255; end
...
%Grid manual
% grid1=plot(0:1:(day_axis-1),1*(ones(day_axis, 1)),'color',[0.8,0.8,0.8],'HandleVisibility','off');
% hold on;
% grid2=plot(0:1:(day_axis-1),10*(ones(day_axis, 1)),'color',[0.8,0.8,0.8],'HandleVisibility','off');
% hold on;
% grid3=plot(0:1:(day_axis-1),100*(ones(day_axis, 1)),'color',[0.8,0.8,0.8],'HandleVisibility','off');
% hold on;
% grid4=plot(0:1:(day_axis-1),1000*(ones(day_axis, 1)),'color',[0.8,0.8,0.8],'HandleVisibility','off');
% hold on;
...
% hold on;
 ...
 days = 0:1:n-1;
 fig=semilogy(days,new_deaths7_X/7,'DisplayName',[city,'  ',num2str(tot_deaths(max(size(tot_deaths)),1)),' mortes'],"color",color,'LineWidth', 1.25);
 hold on;
 text (n-1, new_deaths7_X(n,1)/7, [' ',city],'FontSize',fonte_location,"color",color,"Clipping",'on');
...
%Grid manual
% grid1=plot(0:1:(day_axis-1),10*(ones(day_axis, 1)),'color',[0.8,0.8,0.8],'HandleVisibility','off');
% hold on;
% grid2=plot(0:1:(day_axis-1),100*(ones(day_axis, 1)),'color',[0.8,0.8,0.8],'HandleVisibility','off');
% hold on;
% grid3=plot(0:1:(day_axis-1),1000*(ones(day_axis, 1)),'color',[0.8,0.8,0.8],'HandleVisibility','off');
% hold on;
% grid4=plot(0:1:(day_axis-1),10000*(ones(day_axis, 1)),'color',[0.8,0.8,0.8],'HandleVisibility','off');
% hold on;
...
% hold on;
 ...
 days = 0:1:n-1;
 fig=semilogy(days,new_cases7_X/7,'DisplayName',[city,'  ',num2str(tot_cases(max(size(tot_cases)),1)),' casos'],"color",color,'LineWidth', 1.25);
 hold on;
 text (n-1, new_cases7_X(n,1)/7, [' ',city],'FontSize',fonte_location,"color",color,"Clipping",'on');
...
set(gca,'YTickLabel',{'10','100','1k','10k','10k'})
...
% ang = 48.5;
% h1=text(46.5,0.8*max_y,'números dobram a cada 5 dias');
% set(h1,'Rotation',ang,'color',[0.4,0.4,0.4],'horizontalAlignment', 'right','FontSize',7);
% ang = 44;
% h2=text(56,0.8*max_y,'6 dias');
% set(h2,'Rotation',ang,'color',[0.4,0.4,0.4],'horizontalAlignment', 'right','FontSize',7);
% ang = 39;
% h3=text(65.9,0.8*max_y,'7 dias');
% set(h3,'Rotation',ang,'color',[0.4,0.4,0.4],'horizontalAlignment', 'right','FontSize',7);
% ang = 34;
% h4=text(75.2,0.8*max_y,'8 dias');
% set(h4,'Rotation',ang,'color',[0.4,0.4,0.4],'horizontalAlignment', 'right','FontSize',7);

 set(gca,'YTickLabel',{'0.1','1','10','100','1k','10k','100k'})
