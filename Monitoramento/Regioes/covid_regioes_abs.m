...
set(gca,'FontSize',fonte_padrao);
title({'Informativo de progresso da epidemia (mortes)',['Regiões do Brasil em ',datestr(end_time,24)]},'FontSize',fonte_titulo)
...
set(gca,'FontSize',fonte_padrao);
title({'Informativo de progresso da epidemia (casos)',['Regiões do Brasil em ',datestr(end_time,24)]},'FontSize',fonte_titulo)
