...
if (init == 2) city = 'São Gonçalo/RJ'; pop = 1084839; color = [255,130,113]/255; end
if (init == 3) city = 'Niterói/RJ'; pop = 524687; color = [209,227,105]/255; end
...
% hold on;
 ...
 days = 0:1:n-1;
 fig=plot(days,new_deaths7_X/7,'DisplayName',[city,'  ',num2str(tot_deaths(max(size(tot_deaths)),1)),' mortes'],"color",color,'LineWidth', 1.25);
 hold on;
...
% hold on;
 ...
 days = 0:1:n-1;
 fig=plot(days,new_cases7_X/7,'DisplayName',[city,'  ',num2str(tot_cases(max(size(tot_cases)),1)),' casos'],"color",color,'LineWidth', 1.25);
 hold on;
