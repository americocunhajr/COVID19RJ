...
%Legenda
Estados_leg={"Argentina     ";"Bolívia     ";"Brasil     ";"Chile     ";"Colômbia     ";"Costa Rica     ";"Cuba     ";"Equador     ";"México     ";"Panamá     ";"Paraguai     ";"Peru     ";"R. Dominicana     ";"Uruguai     ";"Venezuela     "};
...
set(gca,'YTickLabel',{'0','2000','4000','6000','8000','10000','12000','14000','16000','18000','20000','22000'});
set(gca,'YGrid', 'on');
...
ha2=axes('position',[haPos([3 1])-[.12 -0.66], .24,.12,]);
...
uistack(ha,'bottom');
haPos = get(ha,'position');
ha2=axes('position',[haPos([3 1])-[0.6115 -0.025], 0.7075,.038,]);
[x, map]=imread('bandeiras_al.png');
image(x)
colormap (map)
set(ha2,'handlevisibility','off','visible','off')
...
title({'Testes em relação à população',['América Latina em ',datestr(end_time,24)]},'FontSize',11);
