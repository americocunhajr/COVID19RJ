...
data = readtable([pwd,'/Dados/arquivo_geral.csv']);
...
clearvars -except plot_type init BRASIL data name name_title end_time regions begin_states end_states popBR BR dates
