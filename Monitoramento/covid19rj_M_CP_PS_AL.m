...
hold on;
hfonte=text(max(dates)+355,0,{'Gráfico inspirado em: https://www.endcoronavirus.org/countries','Fonte: https://ourworldindata.org/coronavirus-source-data'});
...
hold on;
hfonte=text(max(dates)+335,0,{'Gráfico inspirado em: https://www.endcoronavirus.org/countries','Fonte: https://ourworldindata.org/coronavirus-source-data'});
set(hfonte,'Rotation',90,'color',[0,0,0],'FontSize',7.5);
