...
for i=1:length(Estados)
    ...
    tabela = tabela_aux;
    img_casos_diarios(i,max_size-height(tabela_aux)+1:end) = tabela.new_cases;
...
if (t == 1) print(gcf,[pwd '/',outputdir,'/',name,'_contagio_semanal-abs_',datestr(end_date,29),'.png'],'-dpng','-r300'); end
if (t == 2) print(gcf,[pwd '/',outputdir,'/',name,'_letalidade_semanal-abs_',datestr(end_date,29),'.png'],'-dpng','-r300'); end
if (t == 3) print(gcf,[pwd '/',outputdir,'/',name,'_contagio-abs_',datestr(end_date,29),'.png'],'-dpng','-r300'); end
if (t == 4) print(gcf,[pwd '/',outputdir,'/',name,'_letalidade-abs_',datestr(end_date,29),'.png',],'-dpng','-r300'); end
