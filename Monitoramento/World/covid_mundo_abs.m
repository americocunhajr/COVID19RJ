...
saveas(gcf,[name,'_letalidade-abs_',datestr(end_time,29),'.png']);
...
saveas(gcf,[name,'_contagio-abs_',datestr(end_time,29),'.png']);
...
saveas(gcf,[name,'_informativo-mortes-abs_',datestr(end_time,29),'.png']);
