...
if (init == 13) city = 'Japeri/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 12) city = 'Paracambi/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 11) city = 'Seropédica/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 10) city = 'Queimados/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 9) city = 'Guapimirim/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 8) city = 'Itaguaí/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 7) city = 'Nilópolis/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 6) city = 'Mesquita/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 5) city = 'Magé/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 4) city = 'Belford Roxo/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 3) city = 'São João de Meriti/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 2) city = 'Nova Iguaçu/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
if (init == 1) city = 'Duque de Caxias/RJ'; color = colors(init*2,:); cityprint = sprintf('%.0f',init); end
