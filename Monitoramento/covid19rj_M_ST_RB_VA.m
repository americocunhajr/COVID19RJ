...
% hold on;
 ...
 hold on;
 text (n-1, new_deaths7_X(n,1)/7, [' ',country],'FontSize',fonte_location,"color",color);
end
...
% hold on;
 ...
 days = 0:1:n-1;
 fig=plot(days,new_cases7_X/7,'DisplayName',[country,' ',num2str(max(tot_cases)),' casos'],"color",color,'LineWidth', linew);
 hold on;
 text (n-1, new_cases7_X(n,1)/7, [' ',country],'FontSize',fonte_location,"color",color);
