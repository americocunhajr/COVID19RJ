...
for(i=1:length(Estados))
text (i, population(i,max_size),[' ',mat2str(round(tests_max(i) ./ population(i,max_size)*1000000))],'HorizontalAlignment', 'left','VerticalAlignment', 'middle','FontSize',8,'Rotation',90)
end
...
set(gca,'YTickLabel',{'100K','1M','10M','100M','1000M','10000M'});
set(gca,'YGrid', 'on');
set(gca,'yminorgrid','off')
title({'Testes em relação aos casos confirmados',['Comparação entre países em ',datestr(end_time,24)]},'FontSize',11);
